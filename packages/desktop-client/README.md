ClearView on the web

## E2E tests

E2E (end-to-end) tests use [Playwright](https://playwright.dev/). Running them requires an ClearView server to be running either locally or on a remote server.
