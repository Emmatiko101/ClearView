...
export function FinancesApp() {
  ...
  useEffect(() => {
    async function run() {
      await global.ClearView.waitForUpdateReadyForDownload();
      dispatch(
        addNotification({
          type: 'message',
          title: t('A new version of ClearView is available!'),
          ...
          button: {
            title: t('Update now'),
            action: async () => {
              await global.ClearView.applyAppUpdate();
            },
          },
        }),
      );
      ...
      if (isOutdated && lastUsedVersion !== latestVersion) {
        dispatch(
          addNotification({
            ...
            title: t('A new version of ClearView is available!'),
            message: t(
              'Version {{latestVersion}} of ClearView was recently released.',
              { latestVersion },
            ),
            sticky: true,
