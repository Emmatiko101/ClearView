  ...
  return (
    <Setting>
      ...
      <View
        ...
        data-vrt-mask
      >
        <Text>Client version: v{window.ClearView?.ACTUAL_VERSION}</Text>
  ...
  return (
    <Setting>
      <Text>
        <strong>{t('IDs')}</strong>
        {t(
          ' are the names ClearView uses to identify your budget internally. There are several different IDs associated with your budget. The Budget ID is used to identify your budget file. The Sync ID is used to access the budget on the server.',
        )}
      </Text>
      <Text>
