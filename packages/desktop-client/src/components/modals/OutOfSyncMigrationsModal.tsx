  ...
  return (
    <Modal name="out-of-sync-migrations">
      {({ state: { close } }) => (
        <>
          <ModalHeader
            title={<ModalTitle title={t('Please update ClearView!')} />}
          />
          <View
            style={{
              padding: 15,
          ...
          >
            <Text>
              <Paragraph style={{ fontSize: 16 }}>
                <Trans>
                  ...
                  ClearView client. Your budget data has been updated by another
                  client, but this client is still on the old verison. For the
                  best experience, please update ClearView to the latest version.
                </Trans>
              </Paragraph>
            </Text>
            ...
            >
              <Trans>
                If you can&apos;t update ClearView at this time you can find the
                latest release at{' '}
