            ...
            {!isRecreating ? (
              <>
                ...
                <Paragraph>
                  ...
                  >
                    ...
                    <li>
                      {t(
                        'This key only applies to this file. You will need to generate a new key for each file you want to encrypt.',
                      )}
                    </li>
                    <li>
                      {t(
                        'If you’ve already downloaded your data on other devices, you will need to reset them. ClearView will automatically take you through this process.',
                      )}
                    </li>
                    <li>
                      {t(
              ...
              <>
                <Paragraph style={{ marginTop: 5 }}>
                  ...
                  {t(
                    ' and all other devices will have to revert to this version of your data. ClearView will take you through that process on those devices.',
                  )}{' '}
                  <Link
                    variant="external"
                    to="https://actualbudget.org/docs/getting-started/sync/#end-to-end-encryption"
                ...
                <Paragraph>
                  {t(
                    'Key generation is randomized. The same password will create different keys, so this will change your key regardless of the password being different.',
                  )}
                </Paragraph>
              </>
            )}
